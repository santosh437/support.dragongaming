    ...
    <form id="wf-form" method="post" action="<?php echo admin_url( 'admin.php?page=oasiswf-admin' ); ?>">
        <div>
            ...
            <span class="description">
	         <?php add_thickbox(); ?>
				...
				<?php echo __( ' You can also look up for more tutorial videos about Oasis Workflow on ',
					"oasisworkflow" ); ?>
        ...
        <div class="fc_action">
            <div id="workflow-info-area">
                <div class="postbox-container" id="process-info-div">
                    <div class="postbox">
                        ...
                        <h3 style="padding:7px;">
                       	...
                       	<a href="#"
                           title="<?php echo __( 'Drag and Drop the processes into the Workflow Design Canvas to create new workflow steps.',
							...
							if ( $wf_editable ) {
								...
								foreach ( $fw_process as $k => $v ) {
									echo "<li class='widget'>
												<div class='widget-wf-process' data-process='" . $k . "'>" .
									     $processes[ $k ] . "</div>
											 </li>";
								}
								echo '</ul>';
								...
								echo __( "Processes are not available, since there are items (post/pages) in the workflow.&nbsp;&nbsp;&nbsp;If you want to edit the workflow,&nbsp;&nbsp; please ",
								     ...
								     __( "save it as a new version", "oasisworkflow" );
								echo "</a></p></li><ul>";
							}
							?>
                        </div>
                            ...
                            <table>
                                    ...
                                    <td>
                                     ...
                                     <a href="#"
                                        title="<?php echo __( 'Specify a date from which this workflow will become available for use.',
	                                        "oasisworkflow" ); ?>" class="tooltip">
                                       <span title="">
                                       <img src="<?php echo OASISWF_URL . '/img/help.png'; ?>"
                                ...
                                <tr>
                                    <td>
										...
										<?php if ( $wf_editable ): ?>
                                            <button class="date-clear"><?php echo __( "clear",
                ...
                <div class="postbox-container">
                    <div class="postbox">
                        <div class="handlediv" title="Click to toggle"><br></div>
                        <h3 style="padding:7px;">
                            <span class="workflow-lbl"><?php echo __( "Workflow Applicable To",
									"oasisworkflow" ); ?></span>
                        </h3>
                        <div class="move-div workflow-define-div">
                            <table>
                            ...
                            <table>
                                <tr>
                                    <td>
                                        <label>
											<span class="space bold-label">
											<?php echo __( "Roles (who can submit to this workflow) :",
												"oasisworkflow" ); ?>
											</span>
                                            <span class="space">
											<?php echo __( " (applicable to all, if none specified)",
												"oasisworkflow" ); ?>
											</span>
                                        </label>
                                    </td>
            ...
            <div class="widget-holder dropable-area" id="workflow-area" style="position:relative;">
                ...
                <span id="workflow-steps-loading-span" class="steps-loading"><?php echo __( "Loading Step...",
						"oasisworkflow" ); ?></span>
            </div>
            <br class="clear">
        </div>
        <div class="save-action-div">
			...
			<?php if ( $wf_editable ) { ?>
				...
				if ( current_user_can( 'ow_edit_workflow' ) ) {
					?>
                    <input type="button" value="<?php echo __( "Save and Close", "oasisworkflow" ) ?>"
