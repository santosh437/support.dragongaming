	...
	public function validate_auto_submit_settings( array $input ) {
		...
		if ( isset( $_POST['auto_submit_btn'] ) ) {
			...
			add_settings_error(
				...
				__( 'Auto submit triggered successfully. ' . $submitted_posts_count . ' posts/page submitted.',
					'oasisworkflow' ),
				'updated'
			);
		}
		...
		if ( $error ) {
			add_settings_error(
				...
				__( 'Please provide keywords for the workflows to participate in auto submit process.',
					'oasisworkflow' ),
				'error'
			);
		}
                        ...
                        <ol>
                            <li>
                                <div class="select-info">
                                    <label class="settings-title"><input type="checkbox"
                                                                         name="<?php echo $this->ow_auto_submit_settings_option_name; ?>[auto_submit_enable]"
                                                                         value="active" <?php echo $auto_submit_settings['auto_submit_enable'] ==
									                                                               'active' ? 'checked'
											: ''; ?> />&nbsp;&nbsp;<?php echo __( "Enable Auto Submit?",
											"oasisworkflow" ); ?>
                                    </label>
                                </div>
                            </li>
                            <li>
                                <div class="select-info">
                                    <div class="list-section-heading">
                                        <label><?php echo __( "Post/Page status(es) to be selected for auto submit:",
												"oasisworkflow" ) ?></label>
                                    </div>
                                    <select
                                        name="<?php echo $this->ow_auto_submit_settings_option_name; ?>[auto_submit_stati][]"
                            ...
                            <li>
                                ...
                                <div class="select-info margin-override">
                                    <input type="checkbox"
                                           name="<?php echo $this->ow_auto_submit_settings_option_name; ?>[search_post_title]"
                                ...
                                <div class="select-info margin-override">
                                    <input type="checkbox"
                                           name="<?php echo $this->ow_auto_submit_settings_option_name; ?>[search_post_tags]"
                                ...
                                <div class="select-info margin-override">
                                    <input type="checkbox"
                                           name="<?php echo $this->ow_auto_submit_settings_option_name; ?>[search_post_categories]"
                                           value="yes" <?php echo $auto_submit_settings['search_post_categories'] ==
									                              'yes' ? 'checked' : ''; ?>/>&nbsp;&nbsp;
                                    <label class="settings-title"><?php echo __( "Categories",
											"oasisworkflow" ); ?> </label>
                                </div>
                                <div class="select-info margin-override">
                                    <input type="checkbox"
                                           name="<?php echo $this->ow_auto_submit_settings_option_name; ?>[search_post_taxonomies]"
                                           value="yes" <?php echo ( isset( $auto_submit_settings['search_post_taxonomies'] ) ) &&
									                              $auto_submit_settings['search_post_taxonomies'] ==
									                              'yes' ? 'checked' : ''; ?>/>&nbsp;&nbsp;
                                    <label class="settings-title"><?php echo __( "Taxonomies / Terms",
											"oasisworkflow" ); ?> </label>
                                </div>
                            </li>
                            <li>
                                <div class="select-info">
                                    ...
                                    <input type="text"
                                           name="<?php echo $this->ow_auto_submit_settings_option_name; ?>[auto_submit_due_days]"
                                           size="4" class="auto_submit_due_days"
                                           value="<?php echo esc_attr( $auto_submit_settings['auto_submit_due_days'] ); ?>"
                                           maxlength=2/>
                                    <label class="settings-title"><?php echo __( "day(s).",
											"oasisworkflow" ); ?></label>
                                </div>
                            </li>
                            <li>
                                <div class="select-info">
                                    ...
                                    <textarea
                                        name="<?php echo $this->ow_auto_submit_settings_option_name; ?>[auto_submit_comment]"
                            ...
                            <li>
                                <div class="select-info">
                                    ...
                                    <input type="text"
                                           name="<?php echo $this->ow_auto_submit_settings_option_name; ?>[auto_submit_post_count]"
                                           size="8" class="auto_submit_post_count"
                                           value="<?php echo esc_attr( $auto_submit_settings['auto_submit_post_count'] ); ?>"
                                           maxlength=4/>
                                    <label class="settings-title"><?php echo __( "posts/pages at one time.",
											"oasisworkflow" ); ?></label>
                                    <br/>
                                    <span
                                        class="description"><?php echo __( "(Limit the number of posts/pages to be processed at one time for optimum server performance.)",
											"oasisworkflow" ); ?></span>
                                </div>
                            </li>
                            <li>
                                <div class="select-info">
                                    <div class="list-section-heading">
                                        <label class="settings-title"><?php _e( "Run Auto Submit Engine every:",
												"oasisworkflow" ) ?></label>
                                        <select
                                            name="<?php echo $this->ow_auto_submit_settings_option_name; ?>[auto_submit_interval]">
                                        ...
                                        <br/>
                                        <span
                                            class="description"><?php echo __( "(How often do you wish to run the auto submit process?)",
												"oasisworkflow" ); ?></span>
                                    </div>
                                </div>
                            </li>
                            <li>
                                <div class="select-info">
                                    ...
                                    <br/>
                                    <span
                                        class="description"><?php echo __( "(Provide keywords(comma separated) for the workflows to participate in auto submit process.)",
											"oasisworkflow" ); ?></span>
                                    <br class="clearfix">
                                    ...
                                    <div class="auto-submit-workflow">
                                        <div class="owf-hidden">
                                            <select
                                                name="<?php echo $this->ow_auto_submit_settings_option_name; ?>[workflow_id][]">
												<?php OW_Utility::instance()->workflows_dropdown( $workflows ); ?>
                                            </select>
                                            <textarea
                                                name="<?php echo $this->ow_auto_submit_settings_option_name; ?>[keywords][]"
                                                rows="1" cols="50"
                                                placeholder="<?php echo __( 'Keywords for Auto Submit(comma separated)',
                                    ...
                                    <img src="<?php echo OASISWF_URL ?>/img/trash.png" title="remove"/>
                                       ...
                                       <img src="<?php echo OASISWF_URL ?>/img/trash.png" title="remove"/>
                                        ...
                                        <div class="no-applicable-workflow <?php echo $class ?>">
											<?php echo __( 'No applicable workflows found. Click the "+ Assign Workflow" button to add workflows.',
												'oasisworkflow' ); ?>
                                        </div>
                                        <div class="owf-as-button">
                                            <input type="button" name="add-workflow" id="add-workflow"
                                                   value="<?php _e( '+ Assign Workflow', 'oasisworkflow' ); ?>"
                        ...
                        <div class="select-info full-width">
                            <div id="owf_settings_button_bar">
                                ...
                                <input type="submit" id="auto_submit_btn"
                                       ...
                                       value="<?php echo __( "Trigger Auto Submit - Just One Time",
									       "oasisworkflow" ); ?>"/>
                            </div>
                        </div>
                    </div>
