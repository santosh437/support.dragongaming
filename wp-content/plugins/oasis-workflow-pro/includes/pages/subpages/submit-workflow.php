...
$publish_date_label           = ! empty( $workflow_terminology_options['publishDateText'] )
	? $workflow_terminology_options['publishDateText'] : __( 'Publish Date', 'oasisworkflow' );
						...
						if ( $ow_workflow_service->is_workflow_applicable( $workflow->ID, $post_id ) ) {
							...
							if ( $is_revision == true && $additional_info['wf_for_revised_posts'] ) {
								...
								if ( $workflow->version == 1 ) {
									...
									echo "<option value={$workflow->ID}>" . $workflow->name . " (" .
									     $workflow->version . ")" . "</option>";
								}
...
ADD_BLANK_OPTION;
            ...
            <div class="owf-text-info left full-width">
                <div class="left">
                    <label><?php echo $due_date_label . " : "; ?>
                        <a href="#" title="<?php echo __( 'Specify a date for the assignment to be completed.',
            ...
            <div class="owf-text-info left full-width">
                <div class="left">
                    <label><?php echo $publish_date_label . " : "; ?>
                        <a href="#"
                           title="<?php echo __( 'Specify a desired publish date for the post.', "oasisworkflow" ); ?>"
                           class="tooltip">
                     <span title="">
                        <img src="<?php echo OASISWF_URL . '/img/help.png'; ?>" class="help-icon"/></span>
                        </a>
    ...
    <div class="select-info left changed-data-set full-width">
        <input type="button" id="submitSave" class="button-primary"
               value="<?php echo __( "Submit", "oasisworkflow" ); ?>"/>
        <input type="button" id="elementorSubmitSave" class="button-primary"
               value="<?php echo __( "Submit", "oasisworkflow" ); ?>" style="display:none;"/>
        <span>&nbsp;</span>
