	...
	<?php while ( have_posts() ) : the_post(); ?>
		...
		<div id="bbp-statistics" class="bbp-statistics">
			...
			<div class="entry-content">
				...
				<?php get_the_content() ? the_content() : _e( '<p>Here are the statistics and popular topics of our forums.</p>', 'helpguru' ); ?>
				...
				<div id="bbpress-forums">
					...
					<?php if ( bbp_view_query( 'popular' ) ) : ?>
						...
						<h2 class="entry-title"><?php _e( 'Popular Topics', 'helpguru' ); ?></h2>
