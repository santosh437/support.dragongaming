                    ...
                    <nav class="main-nav">
                        <ul>
                            ...
                            <?php if (have_rows('menu_item', 'options')): while (have_rows('menu_item', 'options')): the_row();
                                ...
                                ?>
                                <li class="<?php echo (have_rows('dropdown_items')) ? 'has-dropdown' : '' ?> links"
                                    data-content="<?php echo str_replace(' ', '-', strtolower($top_level_link['title'])) ?>">
                                    <a href="<?php echo $top_level_link['url'] ?>"><?php echo $top_level_link['title'] ?>
