...
<?php get_template_part('page-header', 'posts'); ?>
    ...
    <!-- #primary -->
    <div id="primary" class="<?php echo (is_active_sidebar('ht_primary')) ? 'sidebar-left clearfix' : '' ?>">
        <div class="ht-container">

            <!-- #content -->
            <main id="content" role="main" itemtype="http://schema.org/Blog" itemscope="itemscope"
                ...
                <?php if (get_the_author_meta('description') != '') { ?>
                    <section id="entry-author" class="clearfix">
                        ...
                        <?php if (!is_author()) { ?><h3
                                id="entry-author-title"><?php _e('About The Author', 'helpguru') ?></h3><?php } ?>
