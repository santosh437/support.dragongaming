    ...
    class HT_Knowledge_Base_Welcome {
        ...
        */
        function add_ht_kb_welcome_menus(){
            // About Page
            add_dashboard_page(
                __( 'Welcome to HelpGuru Knowledge Base', 'ht-knowledge-base' ),
                __( 'Welcome to HelpGuru Knowledge Base', 'ht-knowledge-base' ),
                'manage_options',
                'ht-kb-welcome',
        ...
        */
        function ht_kb_welcome_screen(){
            ...
            <div id="hkb-welcome" class="wrap about-wrap">
                ...
                <h1><?php _e('Welcome to HelpGuru Knowledge Base', 'ht-knowledge-base');  ?></h1>

                <div class="about-text">
                    <?php printf(__('Welcome to HelpGuru Knowledge Base %s, thanks for choosing this plugin, which adds a feature rich knowledge base to your WordPress powered site.', 'ht-knowledge-base'), HT_KB_VERSION_NUMBER); ?>
                </div>
                ...
                <div class="hkb-grid">
                    ...
                    <div class="hkb-grid__col hkb-grid__6">
                        ...
                        <?php endif; ?>
                        <p><?php printf(__('If you need any assistance in setting up your Knowledge Base, be sure to check out the documentation and knowledge base at the <a href="%s" target="_blank">HelpGuru Theme Documentation Page</a>.', 'ht-knowledge-base'), HT_KB_SUPPORT_URL); ?></p>
                    </div>
                </div>
