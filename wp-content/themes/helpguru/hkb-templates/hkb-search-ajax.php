  ...
  <?php $total_results = 0; ?>
    ...
    <?php if($total_results>0): ?>
      <li class="hkb-searchresults__showall">
        <a href="<?php echo site_url( '?s=' . $s . '&ht-kb-search=1' ); ?>" title="<?php _e('Show all results', 'helpguru'); ?>"><?php _e('Show all results', 'helpguru'); ?></a> 
      </li>
    <?php else: ?>
      <li class="hkb-searchresults__noresults">
        <span><?php _e('No Results', 'helpguru'); ?></span>
      </li>
    <?php endif; ?>
