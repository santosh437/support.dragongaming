...
<div id="step-setting">
    ...
    <div id="step-setting-content" style="overflow:auto;">
        <p class="step-name">
            <label><?php echo __( "Step Name :", "oasisworkflow" ) ?> </label><input type="text" id="step-name"
                                                                                     name="step-name"/>
        </p>
        ...
        <div>
            <div style="margin-left:0px;">
                <label>
                    ...
                    <a href="#"
                       title="<?php echo __( 'Check this box to assign the task to all the users in this step and hide the assignee list during the sign off process.',
						   "oasisworkflow" );
					   ?>" class="tooltip">
                  <span title="">
            ...
            <span>
            <input type="checkbox" id="assign_to_all" value="1" <?php echo is_object( $step_info ) &&
                                                                           isset( $step_info->assign_to_all )
		...
		<?php if ( $show_step_due_date == 'yes' ) :
            ...
            <div class="owf-text-info left full-width">
                <div class="left">
                    <label><?php echo __( "Default", "oasisworkflow" ) . " <br> " .
					                  __( "Due Date:", "oasisworkflow" ); ?>
                        <a href="#"
                           title="<?php echo __( 'Specify a default due date for this step to be completed. This is an optional setting.',
                ...
                <div class="left">
                    <input type="text" id="step_due_days"
                           ...
                           maxlength=2/>
                    <span
                        id="step-settings">&nbsp; <?php echo __( " day(s) after the post is submitted to the workflow.",
							"oasisworkflow" ); ?> </span>
                </div>
            </div>
            <br class="clear">
            ...
            <fieldset class="first-step-fieldset">
                ...
                <select name="first_step_post_status" id="first_step_post_status">
					...
					<?php foreach ( $status_array as $status_id => $status_object ) {
						...
						?>
                        <option value="<?php echo $status_id; ?>" <?php selected( $status_id,
							'draft' ); ?>><?php echo $status_object->label; ?></option>
					<?php } ?>
                </select>
		...
		<?php if ( $process_name == 'publish' ) { ?>
            <div class="ow-fieldset">
                <fieldset class="last-step-fieldset">
                    ...
                    <label><?php echo __( 'Post Status: ', 'oasisworkflow' ); ?>
                        <a href="#" title="<?php echo __( 'Set post status after workflow process is complete.',
							"oasisworkflow" );
						?>" class="tooltip">
                       <span title="">
                           <img src="<?php echo OASISWF_URL . 'img/help.png'; ?>" class="help-icon"/>
                    ...
                    <select name="last_step_post_status" id="last_step_post_status">
						...
						<?php foreach ( $status_array as $status_id => $status_object ) {
							...
							?>
                            <option value="<?php echo $status_id; ?>" <?php selected( $status_id,
								$selected_status ); ?>><?php echo $status_object->label; ?></option>
						<?php } ?>
                    </select>
                    <br class="clear">
                </fieldset>
        ...
        <div>
            <div style="margin-left:0px;">
                <label><?php echo __( 'Sign off Action Text: ', 'oasisworkflow' ); ?>
                    <a href="#"
                       title="<?php echo __( 'Specify the text for sign off actions that should appear when user is signing off from a given task.',
						   "oasisworkflow" );
					   ?>" class="tooltip">
                  <span title="">
                     <img src="<?php echo OASISWF_URL . 'img/help.png'; ?>" class="help-icon"/>
            ...
            if ( $process_name == 'review' ) {
             ...
             <div>
                 ...
                 <div style="float:left;">
                    <input type="text" id="signoff_success_action" placeholder="<?php echo $success_placeholder; ?>"
             ...
             <div>
                 ...
                 <div style="float:left;">
                    <input type="text" id="signoff_failure_action" placeholder="<?php echo $failure_placeholder; ?>"
        ...
        <h3 class="nav-tab-wrapper" id="step_email_content">
            <a class="nav-tab nav-tab-active" href="#assignment_email"><?php echo __( "Assignment Email",
					"oasisworkflow" ); ?></a>
        ...
        <form>
            <div id="assignment_email">
                ...
                <div>
                    <div class="place-holder"><label><?php echo __( "Placeholder : ", "oasisworkflow" ); ?></label>
                    </div>
                    <div class="left">
						<?php
                        ...
                        <input type="button" id="addPlaceholderAssignmentSubj" class="button-primary placeholder-add-bt"
                               value="<?php echo __( "Add to subject", "oasisworkflow" ); ?>"
                               style="margin-left:20px;"/>
                        <input type="button" id="addPlaceholderAssignmentMsg" class="button-primary placeholder-add-bt"
                               value="<?php echo __( "Add to message", "oasisworkflow" ); ?>"
                               style="margin-left:20px;"/>
                    </div>
                    <br class="clear">
                </div>
            ...
            <div id="reminder_email" style="display: none;">
                ...
                <div class="email-message-area">
                    <div style="float:left;"><label><?php echo __( "Email message : ", "oasisworkflow" ); ?></label>
                    </div>
                    <div style="float:left;">
    ...
    <p class="step-set">
        ...
        <span>&nbsp;</span>
        <a href="#" id="stepCancel" style="color:blue;margin-top:5px;"><?php echo __( "Cancel",
				"oasisworkflow" ); ?></a>
    </p>
    <br class="clear">
</div>