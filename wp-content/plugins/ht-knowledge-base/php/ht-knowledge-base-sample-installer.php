    ...
    class HT_Knowledge_Base_Sample_Installer {
        ...
        */
        function add_sample_categories(){
            ...
            $name = __('HelpGuru Knowledge Base Plugin', 'ht-knowledge-base');
            $this->add_ht_kb_category($name);
        }
        ...
        */
        function add_sample_articles(){
            ...
            $this->add_sample_ht_kb_article('Knowledge Base WordPress Plugin', $this->get_sample_info_content(), 'HelpGuru Knowledge Base Plugin', array('tips', 'kb', 'tips') );
        }
