...
class OW_Workflow_Terminology_Settings {
	...
	public function add_settings_page() {
		...
		$submit_to_workflow          = ! empty( $workflow_terminology_option['submitToWorkflowText'] )
			? $workflow_terminology_option['submitToWorkflowText'] : __( 'Submit to Workflow', 'oasisworkflow' );
		$sign_off                    = ! empty( $workflow_terminology_option['signOffText'] )
			? $workflow_terminology_option['signOffText'] : __( 'Sign Off', 'oasisworkflow' );
		$continue_to_submit          = ! empty( $workflow_terminology_option['continueToSubmitText'] )
			? $workflow_terminology_option['continueToSubmitText'] : __( 'Continue to Submit', 'oasisworkflow' );
		$continue_to_signoff         = ! empty( $workflow_terminology_option['continueToSignoffText'] )
			? $workflow_terminology_option['continueToSignoffText'] : __( 'Continue to Sign off', 'oasisworkflow' );
		$assign_actors               = ! empty( $workflow_terminology_option['assignActorsText'] )
			? $workflow_terminology_option['assignActorsText'] : __( 'Assign Actor(s)', 'oasisworkflow' );
		$due_date                    = ! empty( $workflow_terminology_option['dueDateText'] )
			? $workflow_terminology_option['dueDateText'] : __( 'Due Date', 'oasisworkflow' );
		$publish_date                = ! empty( $workflow_terminology_option['publishDateText'] )
			? $workflow_terminology_option['publishDateText'] : __( 'Publish Date', 'oasisworkflow' );
		$abort_workflow              = ! empty( $workflow_terminology_option['abortWorkflowText'] )
			? $workflow_terminology_option['abortWorkflowText'] : __( 'Abort Workflow', 'oasisworkflow' );
		$workflow_history            = ! empty( $workflow_terminology_option['workflowHistoryText'] )
			? $workflow_terminology_option['workflowHistoryText'] : __( 'Workflow History' );
		$make_revision               = ! empty( $workflow_terminology_option['makeRevisionText'] )
			? $workflow_terminology_option['makeRevisionText'] : __( 'Make Revision', 'oasisworkflow' );
		$task_priority               = ! empty( $workflow_terminology_option['taskPriorityText'] )
			? $workflow_terminology_option['taskPriorityText'] : __( 'Priority', 'oasisworkflow' );
		$duplicate_post              = ! empty( $workflow_terminology_option['duplicatePostText'] )
			? $workflow_terminology_option['duplicatePostText'] : __( 'Duplicate Post', 'oasisworkflow' );
		?>
                ...
                <div id="settingstuff">
                    <div class="select-info">
                        <div class="half-width left">
                            <label for="submitToWorkflowText"><?php echo __( "Submit to Workflow", "oasisworkflow" ) .
							                                             __( " Label", "oasisworkflow" ) ?></label>
                        </div>
                        <div class="half-width left">
                            <input type="text" class="regular-text"
                                   name="<?php echo $this->ow_workflow_terminology_option_name; ?>[submitToWorkflowText]"
                                   value="<?php echo esc_attr( $submit_to_workflow ); ?>"/>
                            <p class="description"
                               id="tagline-description"><?php echo __( "Label for \"Submit to Workflow\" button/link.",
									"oasisworkflow" ); ?></p>
                        </div>
                        <br class="clear">
                    </div>
                    <div class="select-info">
                        <div class="half-width left">
                            <label for="continueToSubmitText"><?php echo __( "Continue to Submit", "oasisworkflow" ) .
							                                             __( " Label", "oasisworkflow" ) ?></label>
                        </div>
                        <div class="half-width left">
                            <input type="text" class="regular-text"
                                   name="<?php echo $this->ow_workflow_terminology_option_name; ?>[continueToSubmitText]"
                                   value="<?php echo esc_attr( $continue_to_submit ); ?>"/>
                            <p class="description"
                               id="tagline-description"><?php echo __( "Label for \"Continue to Submit\" button/link.",
									"oasisworkflow" ); ?></p>
                        </div>
                        <br class="clear">
                    </div>
                    <div class="select-info">
                        <div class="half-width left">
                            <label for="signOffText"><?php echo __( "Sign Off", "oasisworkflow" ) .
							                                    __( " Label", "oasisworkflow" ) ?></label>
                        </div>
                        <div class="half-width left">
                            <input type="text" class="regular-text"
                                   name="<?php echo $this->ow_workflow_terminology_option_name; ?>[signOffText]"
                                   value="<?php echo esc_attr( $sign_off ); ?>"/>
                            <p class="description"
                               id="tagline-description"><?php echo __( "Label for \"Sign Off\" button/link.",
									"oasisworkflow" ); ?></p>
                        </div>
                        <br class="clear">
                    </div>
                    <div class="select-info">
                        <div class="half-width left">
                            <label for="continueToSignoffText"><?php echo __( "Continue to Sign off",
				                        "oasisworkflow" ) . __( " Label", "oasisworkflow" ) ?>
                            </label>
                        </div>
                        <div class="half-width left">
                            <input type="text" class="regular-text"
                                   name="<?php echo $this->ow_workflow_terminology_option_name; ?>[continueToSignoffText]"
                                   value="<?php echo esc_attr( $continue_to_signoff ); ?>"/>
                            <p class="description"
                               id="tagline-description"><?php echo __( "Label for \"Continue to Sign off\" button/link.",
									"oasisworkflow" ); ?></p>
                        </div>
                        <br class="clear">
                    </div>
                    <div class="select-info">
                        <div class="half-width left">
                            <label for="assignActorsText"><?php echo __( "Assign Actor(s)", "oasisworkflow" ) .
							                                         __( " Label", "oasisworkflow" ) ?></label>
                        </div>
                        <div class="half-width left">
                            <input type="text" class="regular-text"
                                   name="<?php echo $this->ow_workflow_terminology_option_name; ?>[assignActorsText]"
                                   value="<?php echo esc_attr( $assign_actors ); ?>"/>
                            <p class="description"
                               id="tagline-description"><?php echo __( "Label for \"Assign Actor(s)\" field.",
									"oasisworkflow" ); ?></p>
                        </div>
                        <br class="clear">
                    </div>
                    <div class="select-info">
                        <div class="half-width left">
                            <label for="dueDateText"><?php echo __( "Due Date", "oasisworkflow" ) .
							                                    __( " Label", "oasisworkflow" ) ?></label>
                        </div>
                        <div class="half-width left">
                            <input type="text" class="regular-text"
                                   name="<?php echo $this->ow_workflow_terminology_option_name; ?>[dueDateText]"
                                   value="<?php echo esc_attr( $due_date ); ?>"/>
                            <p class="description"
                               id="tagline-description"><?php echo __( "Label for \"Due Date\" field.",
									"oasisworkflow" ); ?></p>
                        </div>
                        <br class="clear">
                    </div>
                    <div class="select-info">
                        <div class="half-width left">
                            <label for="publishDateText"><?php echo __( "Publish Date", "oasisworkflow" ) .
							                                        __( " Label", "oasisworkflow" ) ?></label>
                        </div>
                        <div class="half-width left">
                            <input type="text" class="regular-text"
                                   name="<?php echo $this->ow_workflow_terminology_option_name; ?>[publishDateText]"
                                   value="<?php echo esc_attr( $publish_date ); ?>"/>
                            <p class="description"
                               id="tagline-description"><?php echo __( "Label for \"Publish Date\" field on the \"Submit to Workflow\" popup.",
									"oasisworkflow" ); ?></p>
                        </div>
                        <br class="clear">
                    </div>
                    <div class="select-info">
                        <div class="half-width left">
                            <label for="abortWorkflowText"><?php echo __( "Abort Workflow", "oasisworkflow" ) .
							                                          __( " Label", "oasisworkflow" ) ?></label>
                        </div>
                        <div class="half-width left">
                            <input type="text" class="regular-text"
                                   name="<?php echo $this->ow_workflow_terminology_option_name; ?>[abortWorkflowText]"
                                   value="<?php echo esc_attr( $abort_workflow ); ?>"/>
                            <p class="description"
                               id="tagline-description"><?php echo __( "Label for \"Abort Workflow\" button/link.",
									"oasisworkflow" ); ?></p>
                        </div>
                        <br class="clear">
                    </div>
                    <div class="select-info">
                        <div class="half-width left">
                            <label for="workflowHistoryText"><?php echo __( "Workflow History", "oasisworkflow" ) .
							                                            __( " Label", "oasisworkflow" ) ?></label>
                        </div>
                        <div class="half-width left">
                            <input type="text" class="regular-text"
                                   name="<?php echo $this->ow_workflow_terminology_option_name; ?>[workflowHistoryText]"
                                   value="<?php echo esc_attr( $workflow_history ); ?>"/>
                            <p class="description"
                               id="tagline-description"><?php echo __( "Label for \"Workflow History\" menu.",
									"oasisworkflow" ); ?></p>
                        </div>
                        <br class="clear">
                    </div>
                    <div class="select-info">
                        <div class="half-width left">
                            <label for="makeRevisionText"><?php echo __( "Make Revision", "oasisworkflow" ) .
							                                         __( " Label", "oasisworkflow" ) ?></label>
                        </div>
                        <div class="half-width left">
                            <input type="text"
                                   name="<?php echo $this->ow_workflow_terminology_option_name; ?>[makeRevisionText]"
                                   value="<?php echo esc_attr( $make_revision ); ?>"/>
                            <p class="description"
                               id="tagline-description"><?php echo __( "Label for \"Make Revision\" button/link.",
									"oasisworkflow" ); ?></p>
                        </div>
                        <br class="clear">
                    </div>
                    <div class="select-info">
                        <div class="half-width left">
                            <label for="addingTaskPriority"><?php echo __( "Priority", "oasisworkflow" ) .
							                                           __( " Label", "oasisworkflow" ) ?></label>
                        </div>
                        <div class="half-width left">
                            <input type="text"
                                   name="<?php echo $this->ow_workflow_terminology_option_name; ?>[taskPriorityText]"
                                   value="<?php echo esc_attr( $task_priority ); ?>"/>
                            <p class="description"
                               id="tagline-description"><?php echo __( "Label for \"Priority\" field on the \"Submit to Workflow\" and \"Sign Off\" popup.",
									"oasisworkflow" ); ?></p>
                        </div>
                        <br class="clear">
                    </div>
                    ...
                    <div class="select-info">
                        <div class="half-width left">
                            <label for="duplicatePost"><?php echo __( "Duplicate Post", "oasisworkflow" ) .
							                                      __( " Label", "oasisworkflow" ) ?></label>
                        </div>
                        <div class="half-width left">
                            <input type="text"
                                   name="<?php echo $this->ow_workflow_terminology_option_name; ?>[duplicatePostText]"
                                   value="<?php echo esc_attr( $duplicate_post ); ?>"/>
                            <p class="description"
                               id="tagline-description"><?php echo __( "Label for \"Duplicate Post\" link.",
									"oasisworkflow" ); ?></p>
                        </div>
                        <br class="clear">
                    </div>
