                ...
                <div id="settingstuff">
                    <div class="select-info">
                        ...
                        <span class="description">
							 	<?php echo __( "(After you are done setting up your editorial workflow, make it available for use by activating the workflow process.)",
								    "oasisworkflow" ); ?>
							 </span>
                    </div>
                    ...
                    <div class="select-info">
                        ...
                        <label class="indented-label">
							...
							<?php _e( 'Allow to override the Default Due Date on each step of the workflow.',
								'oasisworkflow' ); ?>
                        </label>
                    </div>
...
TRIGGER_EVENT;
                    ...
                    <div class="select-info">
                        <div class="list-section-heading">
                            <label>
								<?php echo __( "Show Workflow options for the following post/page types:",
									"oasisworkflow" ) ?>
                            </label>
                        </div>
                    ...
                    <div class="select-info">
                        <div class="list-section-heading">
                            <label>
								<?php echo __( "Make Workflow Inbox as the dashboard for the following roles:",
									"oasisworkflow" ) ?>
                            </label>
                        </div>
						<?php OW_Utility::instance()->owf_checkbox_roles_multi(
                    ...
                    <div class="select-info">
                        ...
                        <br/>
                        <span class="description">
							 	<?php echo __( "(Allows user to specify priority when signing off the task.)",
								    "oasisworkflow" ); ?>
							 </span>
                    </div>
                    ...
                    <div class="select-info">
                        <label class="settings-title">
                            <input type="checkbox"
                                   name="<?php echo $this->ow_comments_setting_option_name; ?>"
                                   value="mandatory" <?php checked( $comments_setting, 'mandatory' ); ?>/>
							<?php _e( 'Make Workflow comments required.', 'oasisworkflow' ); ?>
                        </label>
                        <br/>
                        <span class="description">
							 	<?php echo __( "(Users will be required to provide comments during submit, sign-off, reassign, abort action.)",
								    "oasisworkflow" ); ?>
							 </span>
                    </div>
                    ...
                    <div class="select-info">
                        <label class="settings-title">
							...
							<?php _e( 'Display Oasis Workflow Sidebar as default for Gutenberg Editor.',
								'oasisworkflow' ); ?>
                        </label>
                    </div>
                    ...
                    <div class="select-info">
                        ...
                        <input type="checkbox"
                               name="<?php echo $this->ow_auto_delete_history_setting_option_name ?>[enable]"
                               value="yes" <?php echo $check; ?>/>
                        <label class="settings-title">
							<?php echo __( "Delete Workflow History for posts/pages which were last updated :",
								"oasisworkflow" ); ?>
                        </label>
                        ...
                        <br/>
                        <span class="description">
							 	<?php echo __( "(A cron job will run once a day to purge the workflow history for completed workflows.)",
								    "oasisworkflow" ); ?>
							 </span>
                    </div>
